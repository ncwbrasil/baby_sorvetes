...
<body>
	<div id='janela' class='janela' style='display:table;'> </div>
	<?php
	...
	$mail = new PHPMailer();
	$mail->IsSMTP();
	$mail->Host = "mail.babysorvetes.com.br"; // Endereço do servidor SMTP (caso queira utilizar a autenticação, utilize o host smtp.seudomínio.com.br)
	$mail->SMTPAuth = true; // Usa autenticação SMTP? (opcional)
	$mail->Username = 'autenticacao@babysorvetes.com.br'; // Usuário do servidor SMTP
	$mail->Password = 'infomogi123'; // Senha do servidor SMTP
	$mail->From = "$email"; // Seu e-mail
	$mail->Sender = "autenticacao@babysorvetes.com.br"; // Seu e-mail
	$mail->FromName = "$nome"; // Seu nome

	$mail->AddAddress('baby.perracine@gmail.com');
	$mail->addBCC('leads@ncwbrasil.com.br');
	$mail->IsHTML(true); // Define que o e-mail será enviado como HTML
	$mail->CharSet = 'utf-8'; // Charset da mensagem (opcional)

	$assunto = $ttl . ' - Formulário de Contato';
