...
$sql = "SELECT COUNT(cur_id) as valor FROM cadastro_cursos";
...
<div class='quad-int'><i class="nc-icon nc-vector"></i>
    <i class="fas fa-graduation-cap" style="color:#000"></i> 
    <div class='txt'>
        Cursos cadastrados<br>
        <span class='n'><?php echo $atual;?></span> <br>
    </div>		
    <div class='more'>
        <a href='cadastro_cursos/view'><i class="fas fa-cog"></i> Gerenciar</a>
    </div>
</div>